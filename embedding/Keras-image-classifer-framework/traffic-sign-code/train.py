...
def train(aug,trainX,trainY,testX,testY,args):
    ...
    model = LeNet.build(width=width_size, height=height_size, depth=3, classes=CLASS_NUM)
    ...
    H = model.fit_generator(aug.flow(trainX, trainY, batch_size=BS),
        validation_data=(testX, testY), steps_per_epoch=len(trainX) // BS, callbacks=callbacks_list,
